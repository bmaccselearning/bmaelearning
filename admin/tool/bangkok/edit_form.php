...
class course_edit_form extends moodleform {
    ...
    function definition() {
        ...
        $strategicSubOptions = array();
        $strategicSubOptions[0] = 'กรุณาเลือก'; // เพิ่มตัวเลือกเริ่มต้น

        //$strategicsub = $DB->get_records_menu('strategic_sub', null, '', 'id, name, strategic_id');
        ...
        $mform->disabledIf('strategic_sub', 'strategic', 'eq', '0'); // ซ่อน dropdown ของ strategic_sub เมื่อ strategic มีค่าเป็น 0
        ...
        $mform->addElement('static', 'strategic_sub_script', '', '<script>
            document.getElementById(\'id_strategic\').addEventListener(\'change\', function() {
                ...
                xhr.open(\'GET\', \'get_subplans.php?strategic_id=\' + strategic_id, true);
                xhr.send();
            });
        </script>');
