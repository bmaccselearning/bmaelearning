...
$url = new moodle_url('/admin/tool/bangkok/addstrategic.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $id = $DB->insert_record('strategic', $strategic);
        if ($id) {
        ...
        redirect(new moodle_url('/admin/tool/bangkok/managestrategic.php'), get_string('strategic_added', 'tool_bangkok'), null, \core\output\notification::NOTIFY_SUCCESS);
...
echo html_writer::tag('label', get_string('strategic_name', 'tool_bangkok'), array('for' => 'name'));
