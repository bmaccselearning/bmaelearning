...
function useredit_shared_definition(&$mform, $editoroptions, $filemanageroptions, $user) {
    ...
    $mform->addElement('text', 'alternatename', get_string('alternatename'), 'maxlength="20" size="25"');
    ...
    $mform->addElement('text', 'middlename', get_string('middlename'), 'maxlength="20" size="25"');
    $mform->setType('middlename', core_user::get_property_type('middlename'));
    $mform->setForceLtr('middlename');
...
/*     if (isset($CFG->forcetimezone) and $CFG->forcetimezone != 99) {
 ...
 /* 
   ...
   if (core_tag_tag::is_enabled('core', 'user') and empty($USER->newadminuser)) {
    ...
    $mform->addElement('text', 'institution', get_string('institution'), 'maxlength="255" size="35"');
    ...
    $mform->setType('phone1', core_user::get_property_type('phone1'));
    $mform->setForceLtr('phone1');  */
    $mform->addElement('text', 'lastnamephonetic', get_string('lastnamephonetic'), 'maxlength="20" size="25"'); //section
    $mform->setType('lastnamephonetic', core_user::get_property_type('lastnamephonetic'));
    $mform->setForceLtr('lastnamephonetic');
    
    $mform->addElement('text', 'firstnamephonetic', get_string('firstnamephonetic'), 'maxlength="20" size="25"'); //job
    $mform->setType('firstnamephonetic', core_user::get_property_type('firstnamephonetic'));
    $mform->setForceLtr('firstnamephonetic');

    $mform->addElement('text', 'phone2', get_string('phone2'), 'maxlength="20" size="25"'); //pos_num
    $mform->setType('phone2', core_user::get_property_type('phone2'));
    $mform->setForceLtr('phone2');

    $mform->addElement('text', 'address', get_string('address'), 'maxlength="255" size="25"'); //work_line
