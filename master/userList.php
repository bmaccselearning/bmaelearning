...
echo "<script type=\"text/javascript\" src=\"ajax/js/user.js\"></script>";

echo "<script> window.onload = function() {document.getElementById(\"form1\").department_code.value='00';showUser('00','','','')}; </script>";
echo "<script>
...
echo "<div class='form-group row fitem'><div class='col-md-3 col-form-label d-flex pb-0 pr-md-0'> </div><div class='column'><input type='button' name='search' value='ค้นหา' onclick='showUser(document.getElementById(\"form1\").department_code.value,document.getElementById(\"form1\").division_code.value,document.getElementById(\"form1\").section_code.value,document.getElementById(\"form1\").job_code.value)' class='btn btn-primary'/></div></div>";
echo "</form>";
...
echo "<h3>รายชื่อผู้ใช้งานแยกตามหน่วยงาน</h3>";
