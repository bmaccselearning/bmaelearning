...
if (!empty($username)) {
    ...
    $sql = "SELECT *
              FROM view_users_division where department_code='".$department_code."' " ;
...
$table->head[] = "รหัสส่วนราชการ";
$table->head[] = "ชื่อส่วนราชการ";
...
foreach ($departmentList as $departmentid) {
   ...
   $row[] = $departmentid->department_code;
    ...
    $row[] = "<a href=\"../master/section.php?department_code=$departmentid->department_code&ampdeparm\">$departmentid->division_name</a>"; 
