...
$contextPath='http://'.$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/adminXml.php?";
...
<th class=\"header c1\" style=\"\" scope=\"col\">รหัสตำแหน่งทางการบริหาร</th>
<th class=\"header c2\" style=\"width:30%\" scope=\"col\">ตำแหน่งทางการบริหาร</th>
